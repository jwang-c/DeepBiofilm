#########################################################################################
# main script for 3D Cyclic GAN l21 with unbalanced training loss
#
...
class CycleGANModel_l21(BaseModel):
    def name(self):
        return 'CycleGANModel_l21'
    ...
    def initialize(self, opt):
        ...
        # load/define networks, note: G_A and G_B denotes G_LR and G_RL in our paper
    ...
    def backward_G(self):
        ...
        loss_cycle_A = torch.nn.MSELoss(reduction='mean')(rec_A, self.real_A) * lambda_A
        # Backward cycle loss
        ...
        self.loss_G = loss_G.data.cpu().numpy()
        self.loss_G_A = loss_G_A.data.cpu().numpy()
        self.loss_G_B = loss_G_B.data.cpu().numpy()
        self.loss_cycle_A = loss_cycle_A.data.cpu().numpy()
        self.loss_cycle_B = loss_cycle_B.data.cpu().numpy()
